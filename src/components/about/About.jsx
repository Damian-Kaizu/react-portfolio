  ...
  return (
    <section className='about section'>
      ...
      <div className="about__container container grid">
        <img src={Offenbach} alt="" className='about__img' />
...
<<<<<<< HEAD
          <a href={CV} download="" className="btn button--flex from-center">Download CV
            <svg
              class="button__icon"
=======
          <a href={CV} download="" className="button button--flex from-center">Download CV
            <svg
              class="button__icon"
              id="cv_icon"
